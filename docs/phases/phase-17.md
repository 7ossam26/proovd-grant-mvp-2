...
|---|---|---|---|
| **17a** | Glance, Act, Explore (1–3), and the threshold/campaign event substrate (5): derived new/canceled/net counts, threshold crossings, milestones, and the absence of any scheduled engagement email | **§33.6.6–§33.6.11** | **built** |
| **17b** | Live editing's three tiers (4), the Creator live surface (6), mid-campaign Creator addition (7), and the Backer before close (8) — including the §18 comment thread §33.6.6–13 left for the Backer identity | **§33.6.12, §33.6.13** | **built** |
