# Build log archive — the full CLAUDE.md as of 2026-08-22

This is the **complete, unedited** engineering narrative that CLAUDE.md carried until
2026-08-22, preserved byte for byte below the line. It was moved here because it had grown
to 4,641 lines / 765 KB — 1.6x the size of the product brief — and was loaded into context
on every session, burying the ~450 lines of actual rules inside ~4,200 lines of history.

**CLAUDE.md now carries the rules plus a condensed per-area summary.** This file is the
long form. Nothing here was reworded; where CLAUDE.md's summary is thinner than you need,
the full account of that decision is below.

**Read this file when** you are about to change an area whose behaviour looks wrong, and
you want to know whether it is a defect or a recorded decision. Search it for the surface
name, the section number, or the date. The chronology runs Phase 00 through the
2026-08-21 listing-fee rebuild.
